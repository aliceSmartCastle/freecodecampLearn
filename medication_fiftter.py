...
def find_invalid_records(patient_id: str|object, age: int|object, gender: str|object, diagnosis: str|object, medications: list|object,
                         last_visit_id: str|object) -> list[str]:
    constraints = {
...
def validate(data: list[dict[str, object]]|Any) -> bool:
